...
(function () {
  ...
  /* ---------- Telegram bot notifications ----------
     Relays every website request to a Telegram chat via the Bot API, in
     addition to the WhatsApp deep link opened by the request form below.
     Fire-and-forget: it never blocks or delays the existing WhatsApp /
     success-screen flow, and failures are only logged to the console.
     ========================================================= */
  var TELEGRAM_BOT_TOKEN = "8559726245:AAE_DZjrgQKNXm5LzYegwlIyuL-xS8sip3g";
  var TELEGRAM_CHAT_ID = "1126151371";

  function sendToTelegram(name, phone, comment, telegram) {
    var tr = {
      ru: { hd: '🆕 НОВАЯ ЗАЯВКА!', src: 'Источник', nm: 'Имя', ph: 'Телефон', cmt: 'Комментарий', tg: 'Telegram', tm: 'Время' },
      en: { hd: '🆕 NEW REQUEST!',  src: 'Source',    nm: 'Name', ph: 'Phone',  cmt: 'Comment',      tg: 'Telegram', tm: 'Time' },
      uz: { hd: "🆕 YANGI SO'ROV!", src: 'Manba',     nm: 'Ism',  ph: 'Telefon', cmt: 'Izoh',        tg: 'Telegram', tm: 'Vaqt' }
    };
    var t = tr[currentLang] || tr.ru;
    var cx = comment  ? '\n' + t.cmt + ': ' + comment  : '';
    var tx = telegram ? '\n' + t.tg  + ': ' + telegram : '';
    var text = t.hd + '\n\n' + t.src + ': moydeklarant.uz\n' + t.nm + ': ' + name + '\n' + t.ph + ': ' + phone + cx + tx + '\n' + t.tm + ': ' + new Date().toLocaleString('ru-RU');
  ...
  if (requestForm) {
    requestForm.addEventListener('submit', function (e) {
      ...
      // Also relay the same request to the Telegram bot. Fire-and-forget —
      // this runs alongside the WhatsApp popup above and never blocks or
      // delays it or the success screen below.
      sendToTelegram(name, phone, comment, telegram);
  ...
  var translations = {
    ...
    en: {
      ...
      'nav.cta': 'Get a quote',
      'hero.eyebrow': 'Customs services & logistics',
      'hero.title': 'Your reliable<br>customs partner',
      'hero.lead': 'Professional customs clearance, logistics and foreign trade support for your business.',
      ...
      'about.text': 'We are a team of professionals that helps businesses clear customs quickly and safely — from the first consultation to cargo release.',
      ...
      'services.sub': 'A full range of customs and logistics services for foreign trade activity.',
      'svc.1.title': 'Customs clearance',
      'svc.1.text': 'End-to-end clearance and support for import and export cargo.',
      ...
      'directions.sub': "We work with the world's leading countries and help arrange import and export of any goods.",
    ...
    uz: {
      ...
      'hero.eyebrow': 'Bojxona xizmatlari va logistika',
      'hero.title': 'Sizning ishonchli<br>bojxona hamkoringiz',
      'hero.lead': "Biznesingiz uchun professional bojxona rasmiylashtiruvi, logistika va tashqi iqtisodiy faoliyatni qo'llab-quvvatlash.",
      ...
      'about.text': "Biz — birlamchi maslahatdan yukni chiqarishgacha bizneslarga bojxona tartib-taomillarini tez va xavfsiz o'tishga yordam beradigan professionallar jamoasimiz.",
      ...
      'services.sub': "Tashqi iqtisodiy faoliyat uchun bojxona va logistika xizmatlarining to'liq spektri.",
      'svc.1.title': 'Bojxona rasmiylashtiruvi',
      'svc.1.text': 'Import va eksport yuklarini rasmiylashtirish va qoʻllab-quvvatlashning toʻliq sikli.',
      ...
      'directions.sub': "Dunyoning yetakchi davlatlari bilan ishlaymiz. Har qanday tovarlarni import va eksport qilishda yordam beramiz.",
